...
">
    ...
    <title> Edit | List Data | CRUD PHP</title>
</head>
<body>
    <!-- Navbar -->
  ...
  <div class="row mb-3">
    <div class="col-md">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control w-50" id="id" name="id" autocomplete="off" required readonly>
        </div>
        <div class="mb-3">
            <label for="title" class="form-label">Title</label>
            <input type="text" class="form-control w-50" id="title" name="title" autocomplete="off" required>
        </div>
        <div class="mb-3">
            <label for="body" class="form-label">Body</label>
            <input type="text" class="form-control w-50" id="body" name="body" autocomplete="off" required>
        </div>
        <hr>
